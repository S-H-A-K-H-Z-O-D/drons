...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'backgroundColor': "var(--bttb-color, linear-gradient(270deg, #F95247 0%, #D3488B 52.08%, #069DFE 100%))",
        'linearHover': 'linear-gradient(270deg, #FE817C 0%, #F897C0 45.31%, #92D0F9 100%)',
        'backgroundTech': "linear-gradient(123deg, rgba(255, 255, 255, 0.20) 0%, rgba(255, 255, 255, 0.04) 100%)",
        'backgroundMobileNav': "rgba(255, 255, 255, 0.80)",
        'backgroundServise': "linear-gradient(226deg, rgba(37, 81, 153, 0.5) 0%, rgba(103, 13, 40, 0.5) 100%)",
      },
    }
  },
  plugins: []
